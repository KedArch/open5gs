...
{
    OpenAPI_scheduled_communication_type_rm_t *scheduled_communication_type_rm_local_var = ogs_malloc(sizeof(OpenAPI_scheduled_communication_type_rm_t));
    ogs_assert(scheduled_communication_type_rm_local_var);
