...
OpenAPI_sm_context_create_data_t *OpenAPI_sm_context_create_data_parseFromJSON(cJSON *sm_context_create_dataJSON)
{
    ...
    if (pdu_sessions_activate_list) {
        ...
        double *pdu_sessions_activate_list_local_value = (double *)ogs_calloc(1, sizeof(double));
        if(!pdu_sessions_activate_list_local_value) {
            ogs_error("OpenAPI_sm_context_create_data_parseFromJSON() failed [pdu_sessions_activate_list]");
            goto end;
        }
        *pdu_sessions_activate_list_local_value = pdu_sessions_activate_list_local->valuedouble;
        OpenAPI_list_add(pdu_sessions_activate_listList, pdu_sessions_activate_list_local_value);
        }
    }
