...
void OpenAPI_presence_info_free(OpenAPI_presence_info_t *presence_info)
{
    ...
    if (presence_info->tracking_area_list) {
        ...
        OpenAPI_list_free(presence_info->tracking_area_list);
    ...
    if (presence_info->ecgi_list) {
        ...
        OpenAPI_list_free(presence_info->ecgi_list);
    ...
    if (presence_info->ncgi_list) {
        ...
        OpenAPI_list_free(presence_info->ncgi_list);
    ...
    if (presence_info->global_ran_node_id_list) {
        ...
        OpenAPI_list_free(presence_info->global_ran_node_id_list);
    ...
    if (presence_info->globale_nb_id_list) {
        ...
        OpenAPI_list_free(presence_info->globale_nb_id_list);
        presence_info->globale_nb_id_list = NULL;
    }
    ogs_free(presence_info);
}
...
cJSON *OpenAPI_presence_info_convertToJSON(OpenAPI_presence_info_t *presence_info)
{
    ...
    if (presence_info->tracking_area_list) {
        OpenAPI_list_for_each(presence_info->tracking_area_list, tracking_area_list_node) {
    ...
    if (presence_info->ecgi_list) {
        OpenAPI_list_for_each(presence_info->ecgi_list, ecgi_list_node) {
    ...
    if (presence_info->ncgi_list) {
        OpenAPI_list_for_each(presence_info->ncgi_list, ncgi_list_node) {
    ...
    if (presence_info->global_ran_node_id_list) {
        OpenAPI_list_for_each(presence_info->global_ran_node_id_list, global_ran_node_id_list_node) {
    ...
    if (presence_info->globale_nb_id_list) {
        OpenAPI_list_for_each(presence_info->globale_nb_id_list, globale_nb_id_list_node) {
...
{
    OpenAPI_presence_info_t *presence_info_local_var = NULL;
    ...
    tracking_area_list = cJSON_GetObjectItemCaseSensitive(presence_infoJSON, "trackingAreaList");
    ...
    ecgi_list = cJSON_GetObjectItemCaseSensitive(presence_infoJSON, "ecgiList");
    if (ecgi_list) {
    ...
    ncgi_list = cJSON_GetObjectItemCaseSensitive(presence_infoJSON, "ncgiList");
    if (ncgi_list) {
    ...
    global_ran_node_id_list = cJSON_GetObjectItemCaseSensitive(presence_infoJSON, "globalRanNodeIdList");
    ...
    globale_nb_id_list = cJSON_GetObjectItemCaseSensitive(presence_infoJSON, "globaleNbIdList");
...
OpenAPI_presence_info_t *OpenAPI_presence_info_copy(OpenAPI_presence_info_t *dst, OpenAPI_presence_info_t *src)
{
    ...
    OpenAPI_presence_info_free(dst);
    dst = OpenAPI_presence_info_parseFromJSON(item);
    cJSON_Delete(item);
