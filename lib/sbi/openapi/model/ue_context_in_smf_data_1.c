...
void OpenAPI_ue_context_in_smf_data_1_free(OpenAPI_ue_context_in_smf_data_1_t *ue_context_in_smf_data_1)
{
    ...
    if (ue_context_in_smf_data_1->pdu_sessions) {
        ...
        ue_context_in_smf_data_1->pdu_sessions = NULL;
    }
...
OpenAPI_ue_context_in_smf_data_1_t *OpenAPI_ue_context_in_smf_data_1_parseFromJSON(cJSON *ue_context_in_smf_data_1JSON)
{
    ...
    pdu_sessions = cJSON_GetObjectItemCaseSensitive(ue_context_in_smf_data_1JSON, "pduSessions");
    if (pdu_sessions) {
    ...
    pgw_info = cJSON_GetObjectItemCaseSensitive(ue_context_in_smf_data_1JSON, "pgwInfo");
    if (pgw_info) {
    ...
    emergency_info = cJSON_GetObjectItemCaseSensitive(ue_context_in_smf_data_1JSON, "emergencyInfo");
    if (emergency_info) {
    ...
    if (emergency_info_local_nonprim) {
        OpenAPI_emergency_info_1_free(emergency_info_local_nonprim);
