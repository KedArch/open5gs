...
cJSON *OpenAPI_lte_v2x_auth_1_convertToJSON(OpenAPI_lte_v2x_auth_1_t *lte_v2x_auth_1)
{
    ...
    if (lte_v2x_auth_1->vehicle_ue_auth != OpenAPI_ue_auth_NULL) {
    ...
    if (lte_v2x_auth_1->pedestrian_ue_auth != OpenAPI_ue_auth_NULL) {
...
OpenAPI_lte_v2x_auth_1_t *OpenAPI_lte_v2x_auth_1_parseFromJSON(cJSON *lte_v2x_auth_1JSON)
{
    ...
    vehicle_ue_auth = cJSON_GetObjectItemCaseSensitive(lte_v2x_auth_1JSON, "vehicleUeAuth");
    if (vehicle_ue_auth) {
    ...
    pedestrian_ue_auth = cJSON_GetObjectItemCaseSensitive(lte_v2x_auth_1JSON, "pedestrianUeAuth");
