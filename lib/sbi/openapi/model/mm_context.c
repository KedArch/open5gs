...
OpenAPI_mm_context_t *OpenAPI_mm_context_parseFromJSON(cJSON *mm_contextJSON)
{
    ...
    mm_context_local_var = OpenAPI_mm_context_create (
        ...
        ue_security_capability ? ogs_strdup(ue_security_capability->valuestring) : NULL,
        s1_ue_network_capability ? ogs_strdup(s1_ue_network_capability->valuestring) : NULL,
        ...
        plmn_assi_ue_radio_cap_id ? ogs_strdup(plmn_assi_ue_radio_cap_id->valuestring) : NULL,
        man_assi_ue_radio_cap_id ? ogs_strdup(man_assi_ue_radio_cap_id->valuestring) : NULL,
