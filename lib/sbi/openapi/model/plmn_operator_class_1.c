...
cJSON *OpenAPI_plmn_operator_class_1_convertToJSON(OpenAPI_plmn_operator_class_1_t *plmn_operator_class_1)
{
    ...
    if (plmn_operator_class_1->lcs_client_class == OpenAPI_lcs_client_class_NULL) {
...
OpenAPI_plmn_operator_class_1_t *OpenAPI_plmn_operator_class_1_parseFromJSON(cJSON *plmn_operator_class_1JSON)
{
    ...
    lcs_client_class = cJSON_GetObjectItemCaseSensitive(plmn_operator_class_1JSON, "lcsClientClass");
    if (!lcs_client_class) {
    ...
    lcs_client_ids = cJSON_GetObjectItemCaseSensitive(plmn_operator_class_1JSON, "lcsClientIds");
    if (!lcs_client_ids) {
