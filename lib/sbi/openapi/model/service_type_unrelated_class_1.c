...
void OpenAPI_service_type_unrelated_class_1_free(OpenAPI_service_type_unrelated_class_1_t *service_type_unrelated_class_1)
{
    ...
    if (service_type_unrelated_class_1->allowed_geographic_area) {
        ...
        service_type_unrelated_class_1->allowed_geographic_area = NULL;
    }
    if (service_type_unrelated_class_1->valid_time_period) {
        ...
        service_type_unrelated_class_1->valid_time_period = NULL;
    }
    if (service_type_unrelated_class_1->code_word_list) {
        ...
        service_type_unrelated_class_1->code_word_list = NULL;
    }
...
cJSON *OpenAPI_service_type_unrelated_class_1_convertToJSON(OpenAPI_service_type_unrelated_class_1_t *service_type_unrelated_class_1)
{
    ...
    if (service_type_unrelated_class_1->privacy_check_related_action != OpenAPI_privacy_check_related_action_NULL) {
    ...
    if (service_type_unrelated_class_1->code_word_ind != OpenAPI_code_word_ind_NULL) {
...
OpenAPI_service_type_unrelated_class_1_t *OpenAPI_service_type_unrelated_class_1_parseFromJSON(cJSON *service_type_unrelated_class_1JSON)
{
    ...
    service_type = cJSON_GetObjectItemCaseSensitive(service_type_unrelated_class_1JSON, "serviceType");
    if (!service_type) {
    ...
    allowed_geographic_area = cJSON_GetObjectItemCaseSensitive(service_type_unrelated_class_1JSON, "allowedGeographicArea");
    ...
    privacy_check_related_action = cJSON_GetObjectItemCaseSensitive(service_type_unrelated_class_1JSON, "privacyCheckRelatedAction");
    ...
    code_word_ind = cJSON_GetObjectItemCaseSensitive(service_type_unrelated_class_1JSON, "codeWordInd");
    if (code_word_ind) {
    ...
    valid_time_period = cJSON_GetObjectItemCaseSensitive(service_type_unrelated_class_1JSON, "validTimePeriod");
    if (valid_time_period) {
    valid_time_period_local_nonprim = OpenAPI_valid_time_period_1_parseFromJSON(valid_time_period);
    }

    code_word_list = cJSON_GetObjectItemCaseSensitive(service_type_unrelated_class_1JSON, "codeWordList");
    if (code_word_list) {
