...
OpenAPI_access_and_mobility_subscription_data_t *OpenAPI_access_and_mobility_subscription_data_parseFromJSON(cJSON *access_and_mobility_subscription_dataJSON)
{
    ...
    if (rat_restrictions) {
        cJSON *rat_restrictions_local_nonprimitive = NULL;
    ...
    if (core_network_type_restrictions) {
        cJSON *core_network_type_restrictions_local_nonprimitive = NULL;
    ...
    if (sor_update_indicator_list) {
        cJSON *sor_update_indicator_list_local_nonprimitive = NULL;
    ...
    if (primary_rat_restrictions) {
        cJSON *primary_rat_restrictions_local_nonprimitive = NULL;
    ...
    if (secondary_rat_restrictions) {
        cJSON *secondary_rat_restrictions_local_nonprimitive = NULL;
    ...
    if (trace_data_local_nonprim) {
        OpenAPI_trace_data_1_free(trace_data_local_nonprim);
